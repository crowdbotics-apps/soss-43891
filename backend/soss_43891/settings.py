"""
Django settings for soss_43891 project.
...
WSGI_APPLICATION = 'soss_43891.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soss_43891 API",
    "DESCRIPTION": "API documentation for soss_43891 App",
    "VERSION": "v1",
}
